...
from util.player_comparisons_pts.model import create_model
from util.player_comparisons.model import train_model
...
plot(y_test, predictions, "2D Input Point Spread Predictions", os.path.join(cache_dir, "plot.png"))
