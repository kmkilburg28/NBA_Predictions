...
from util.average_comparisons_pts.model import create_model
from util.average_comparisons.model import train_model
...
confusion_matrix(y_test, predictions, lambda y: y > 0)

plot(y_test, predictions, "1D Input Point Spread Predictions", os.path.join(cache_dir, "plot.png"))
